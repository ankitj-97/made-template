...
#Create a connection
connection = sqlite3.connect('Cologne_Bicycle_Traffic.sqlite')
...
road_accidents.to_sql("Road_Accident_Data", connection, if_exists='replace', index=False)
bicycle_traffic.to_sql("Bicycle_Traffic_Data", connection, if_exists='replace', index=False)
