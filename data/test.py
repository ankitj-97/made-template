...
def test_dataframe_shape():
    ...
    bicycle_traffic_expected_shape = (24, 14)  # expected shape of the dataframe 2
...
def test_dataframe_columns():
    ...
    bicycle_traffic_expected_columns = ['Month', 'Deutzer Brücke', 'Hohenzollernbrücke', 'Neumarkt',
       ...
       'A.-Silbermann-Weg', 'Stadtwald', 'Niederländer Ufer']  # expected columns of dataframe 2
    

    road_accidents_actual_columns = pipeline.df_2020.columns  # actual columns of dataframe 1
    bicycle_traffic_actual_columns = pipeline.df_2021.columns  # actual columns of dataframe 2
